...
export default function Reviews() {
  const reviews = [
    ...
    },
    {
      ...
      role: 'Клиент нашей компании',
      text: 'Очень довольна работой с Girona Recruitment SL. Все сделали быстро, честно и качественно. Поддерживали меня на каждом этапе и ответили на все вопросы. Рекомендую!',
      image: '/rew_4.jpg',
    },
  ];
